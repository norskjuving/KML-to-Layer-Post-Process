...
###STEP 4 - INSTALL BEAUTIFUL SOUP
 ...
 and you should see the result in figure 5. Congratulations, you have installed Beautiful Soup 4!
  ...
  [Back to Repository](https://github.com/cameronezzi/KML-to-Layer-Post-Process) | [Top of Page](https://github.com/cameronezzi/KML-to-Layer-Post-Process/blob/master/docs_images/bs4_install.md)
