...
def postProcess(kml,outWorkspace,outFC):
    ...
    try:
        ...
        arcpy.SetProgressor("default", "Executing KML to Layer Post Process...")
        ...
        #
        arcpy.env.workspace = os.path.join(arcpy.env.workspace, os.path.splitext(os.path.basename(kml))[0] + ".gdb")
        featureClass = os.path.join(arcpy.env.workspace,"Placemarks",arcpy.ListFeatureClasses("","","Placemarks")[0])
        ...
        time.sleep(readTime)
        arcpy.CreateFeatureclass_management(arcpy.env.workspace,outFC,desc.shapeType.upper(),featureClass,"DISABLED","DISABLED",desc.spatialReference)
        ...
        arcpy.Delete_management(os.path.join(arcpy.env.workspace,"Placemarks"))
